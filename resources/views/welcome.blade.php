...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>3ev PHP Developer Skills Assessment</title>
...
<!--         
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-white sm:items-center py-4 sm:pt-0">
            ...
            <div class="mx-auto text-xl sm:px-6 lg:px-8 justify-center max-w-6xl p-4">
                  <h1 class="text-2xl font-bold leading-tight flex justify-between">
                    ...
                    <p class="text-gray-600 text-sm dark:text-gray-400 p-4">
